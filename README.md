...
<header class="hero" id="top">
  <img src="door_alu_5.jpg" alt="Réalisation menuiserie aluminium">
...
<section class="featured">
  <div class="featured-grid reveal">
    <div class="featured-img"><img src="cuisine_3.jpg" alt="Cuisine sur mesure"></div>
...
<section class="products" id="produits">
  ...
  <div class="product-grid reveal">
    <a href="#galerie" class="product" onclick="setFilter('aluminium')">
      <img src="door_alu_1.jpg" alt="Fenêtres et portes aluminium">
    ...
    <a href="#galerie" class="product" onclick="setFilter('pvc')">
      <img src="door_pvc_1.jpg" alt="Fenêtres et portes PVC">
    ...
    <a href="#galerie" class="product" onclick="setFilter('cuisines')">
      <img src="cuisine_1.jpg" alt="Cuisines et rangements">
    ...
    <a href="#galerie" class="product" onclick="setFilter('douche')">
      <img src="douche_2.jpg" alt="Parois et portes de douche">
...
/* ---------- GALLERY DATA ---------- */
const GALLERY = [
  {src:"door_alu_1.jpg", cat:"aluminium", label:{fr:"Porte aluminium",ar:"باب ألمنيوم",en:"Aluminium door"}},
  {src:"door_alu_2.jpg", cat:"aluminium", label:{fr:"Porte &amp; fenêtre aluminium",ar:"باب ونافذة ألمنيوم",en:"Aluminium door & window"}},
  {src:"door_alu_3.jpg", cat:"aluminium", label:{fr:"Porte aluminium vitrée",ar:"باب ألمنيوم زجاجي",en:"Glazed aluminium door"}},
  {src:"door_alu_4.jpg", cat:"aluminium", label:{fr:"Porte aluminium",ar:"باب ألمنيوم",en:"Aluminium door"}},
  {src:"door_alu_5.jpg", cat:"aluminium", label:{fr:"Baie coulissante aluminium",ar:"باب منزلق ألمنيوم",en:"Aluminium sliding door"}},
  {src:"win_alu_1.jpg", cat:"aluminium", label:{fr:"Fenêtre aluminium à volet",ar:"نافذة ألمنيوم بمصراع",en:"Aluminium shutter window"}},
  {src:"win_alu_2.jpg", cat:"aluminium", label:{fr:"Fenêtre coulissante aluminium",ar:"نافذة ألمنيوم منزلقة",en:"Aluminium sliding window"}},
  {src:"door_pvc_1.jpg", cat:"pvc", label:{fr:"Porte PVC décorative",ar:"باب PVC مزخرف",en:"Decorative PVC door"}},
  {src:"door_pvc_2.jpg", cat:"pvc", label:{fr:"Porte PVC vitrée",ar:"باب PVC زجاجي",en:"Glazed PVC door"}},
  {src:"win_pvc_1.jpg", cat:"pvc", label:{fr:"Fenêtre PVC à deux vantaux",ar:"نافذة PVC بمصراعين",en:"Twin-panel PVC window"}},
  {src:"win_pvc_2.jpg", cat:"pvc", label:{fr:"Installation fenêtres PVC",ar:"تركيب نوافذ PVC",en:"PVC windows installation"}},
  {src:"win_pvc_3.jpg", cat:"pvc", label:{fr:"Fenêtre PVC installée",ar:"نافذة PVC مركبة",en:"Installed PVC window"}},
  {src:"cuisine_1.jpg", cat:"cuisines", label:{fr:"Cuisine sur mesure",ar:"مطبخ حسب الطلب",en:"Custom kitchen"}},
  {src:"cuisine_2.jpg", cat:"cuisines", label:{fr:"Cuisine sur mesure",ar:"مطبخ حسب الطلب",en:"Custom kitchen"}},
  {src:"cuisine_3.jpg", cat:"cuisines", label:{fr:"Cuisine installée",ar:"مطبخ مركب",en:"Installed kitchen"}},
  {src:"cuisine_4.jpg", cat:"cuisines", label:{fr:"Cuisine sur mesure",ar:"مطبخ حسب الطلب",en:"Custom kitchen"}},
  {src:"douche_1.jpg", cat:"douche", label:{fr:"Paroi de douche",ar:"حاجز دش",en:"Shower enclosure"}},
  {src:"douche_2.jpg", cat:"douche", label:{fr:"Paroi de douche installée",ar:"حاجز دش مركب",en:"Installed shower enclosure"}}
];
...
<!-- النوافذ والأبواب -->
<img src="win_alu_1.jpg" alt="نافذة ألومنيوم">
<img src="door_alu_1.jpg" alt="باب ألومنيوم">
<img src="win_pvc_1.jpg" alt="نافذة PVC">
<img src="door_pvc_1.jpg" alt="باب PVC">
<img src="door_alu_2.jpg" alt="باب ألومنيوم مزدوج">
<img src="win_alu_2.jpg" alt="نافذة ألومنيوم مع شتر">
<img src="win_pvc_2.jpg" alt="واجهة نوافذ PVC">
<img src="win_pvc_3.jpg" alt="نافذة سحاب">
<img src="door_alu_3.jpg" alt="باب ألومنيوم مفرد">
<img src="door_pvc_2.jpg" alt="باب PVC مزخرف">

<!-- المطابخ -->
<img src="kitchen_1.jpg" alt="مطبخ رمادي حديث">
<img src="kitchen_2.jpg" alt="مطبخ أبيض">
<img src="kitchen_3.jpg" alt="مطبخ أسود لامع">
<img src="kitchen_4.jpg" alt="مطبخ رمادي داكن">

<!-- كابينات الدش -->
<img src="shower_1.jpg" alt="كابينة دش PVC">
<img src="shower_2.jpg" alt="كابينة دش زجاجية">
<img src="shower_3.jpg" alt="كابينة دش إطار أسود">
